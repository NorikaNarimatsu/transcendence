...
export default function AvatarSelection({ open }: AvatarSelectionProps ) {
    if (!open)
        return null
    ...
    return (
        <div className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-pink-light p-4 z-[1000] border-4 border-solid border-blue-deep">
            <h2 className="font-pixelify text-center text-blue-deep text-xl p-1">Choose your avatar</h2>
